...
Terraform will perform the following actions:
  ...
  + resource "azurerm_linux_virtual_machine" "vm" {
      ...
      + resource_group_name                                    = "rg-pella-dev-eastus"
      + size                                                   = "Standard_B1s"
      + tags                                                   = {
          + "cost_center" = "devops"
          + "environment" = "dev"
  ...
  # azurerm_public_ip.vm will be created
  ...
  # azurerm_storage_container.artifacts will be created
  ...
  # module.vnet.azurerm_network_security_group.this["nsg-pella-dev-eastus-vm"] will be created
  + resource "azurerm_network_security_group" "this" {
      + id                  = (known after apply)
      + location            = "eastus"
      + name                = "nsg-pella-dev-eastus-vm"
      + resource_group_name = "rg-pella-dev-eastus"
  ...
  # module.vnet.azurerm_network_security_rule.this["nsg-pella-dev-eastus-vm-allow-ssh-from-home"] will be created
  + resource "azurerm_network_security_rule" "this" {
      ...
      + network_security_group_name = "nsg-pella-dev-eastus-vm"
      + priority                    = 100
      + protocol                    = "Tcp"
      + resource_group_name         = "rg-pella-dev-eastus"
  ...
  # module.vnet.azurerm_subnet.this["app"] will be created
  + resource "azurerm_subnet" "this" {
      ...
      + resource_group_name                           = "rg-pella-dev-eastus"
      + virtual_network_name                          = "vnet-pella-dev-eastus"
    }

  # module.vnet.azurerm_subnet.this["vm"] will be created
  + resource "azurerm_subnet" "this" {
      + address_prefixes                              = [
          + "10.10.1.0/24",
        ]
  ...
  # module.vnet.azurerm_subnet_network_security_group_association.this["vm"] will be created
...
Changes to Outputs:
  + resource_group_name  = "rg-pella-dev-eastus"
  + storage_account_name = "stpelladeveastus001"
  + subnet_ids           = {
